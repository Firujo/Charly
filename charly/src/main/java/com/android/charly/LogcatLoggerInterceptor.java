 ...
 * This type of interceptor will log everything in the corresponding builder request in your Android
 * Monitor - Logcat
 */
...
public class LogcatLoggerInterceptor implements Interceptor {
  ...
  @Override public Response intercept(Chain chain) throws IOException {
    ...
    httpRequest.setRequestHeaders(
        response.request().headers()); // includes headers added later in the chain
